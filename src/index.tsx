...
import { configDataType, configType, methods, networks } from './config/config';
...
interface ITokenGatingWrapperProps {
  config: configType;
...
// for next Only
export const TokenGatingWrapper: React.FunctionComponent<ITokenGatingWrapperProps> = ({
  config,
  alchemyApiKey,
  children,
}) => {
